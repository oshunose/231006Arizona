...
def test_accessibility(monkeypatch, capsys):
  ...
  assert "We are committed to ensuring that our platform is accessible to all users,including those with disabilities. Here are some of the features we have implemented to enhance accessibility:" in captured.out

  assert "If you encounter any accessibility issues or have suggestions for improvement,please contact us at Team Arizona." in captured.out
...
def test_cookie_policy(monkeypatch, capsys):
  ...
  assert "Our website uses cookies to improve your experience. By continuing to use our site, you accept our use of cookies." in captured.out
...
def test_copyright_policy(monkeypatch, capsys):
  ...
  assert "All content on this platform is protected by copyright laws. The content includes but is not limited to text, images, logos, and graphics \n You may not reproduce, distribute, or modify our content without explicit written permission from us \n For copyright-related inquiries, please contact: legal@incollege.com." in captured.out
...
def test_brand_policy(monkeypatch, capsys):
  ...
  assert "Our brand is a valuable asset, including our name, logo, and visual identity. To maintain consistency and integrity, we have established guidelines for the use of our brand elements. \n \n You may not use our brand elements without prior written permission. Any use must adhere to our brand guidelines \n \n If you require the use of our brand for any purpose, please contact us to request approval." in captured.out
...
def test_language_setting(monkeypatch, capsys):
  ...
  assert "Congratulations, the app language has been changed to Spanish" in captured.out
